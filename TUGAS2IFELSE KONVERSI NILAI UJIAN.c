...
int main()
{
   ...
   printf ("________Perolehan Nilai Kedua__________\n\n");
   printf ("Masukkan Nilai Anda : ");
   scanf  ("%d", &Angka);
   ...
   printf ("________Perolehan Nilai Ketiga_________\n\n");
   printf ("Masukkan Nilai Anda : ");
   scanf  ("%d", &Angka);
   ...
   printf ("________Perolehan Nilai Keempat________\n\n");
   printf ("Masukkan Nilai Anda : ");
   scanf  ("%d", &Angka);
   ...
   printf ("________Perolehan Nilai Kelima_________\n\n");
   printf ("Masukkan Nilai Anda : ");
   scanf  ("%d", &Angka);
